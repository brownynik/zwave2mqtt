...
pm2 start /home/pi/user-scripts/zwave2mqtt.js --name zwave2mqtt-en -i 1 --max-memory-restart 104857600 --node-args="" -- --zwaveport=/dev/ttyUSB-ZStick --out=zwavectrl-en/out --in=zwavectrl-en/in
